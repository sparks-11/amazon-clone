    ...
    <header>
      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        {/* search bar */}
          <div className=" hidden  bg-yellow-400 hover:bg-yellow-500 sm:flex items-center h-10 rounded-md flex-grow cursor-pointer"  >
            <input type="text" className="p-2 h-full w-5 flex-grow flex-shrink rounded-l-md focus:outline-none" />
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap ">
          ...
          <div className="relative flex items-center link"  >
            <span className="absolute top-0 right-0  md:right-10 h-4 w-4 bg-yellow-400 text-center rounded-full text-black font-bold" >5</span>
      ...
      <div className="flex items-center bg-amazon_blue-light text-white text-sm space-x-6 p-2 pl-6">
        <p className="link flex items-center" >
          ...
          <p className="link hidden lg:inline-flex">Health & PersonalCare</p>
      </div>
